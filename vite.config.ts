...
export default defineConfig({
  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: "Lingyu 邻语 — Clipboard Translator",
        short_name: "Lingyu",
        description: "Paste to process: Chinese–English translation, grammar check and English polishing, with the result copied back automatically.",
        lang: "en",
        dir: "ltr",
        display: "standalone",
        start_url: "/",
